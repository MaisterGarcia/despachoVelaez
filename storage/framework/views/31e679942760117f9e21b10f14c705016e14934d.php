	...
	<div class="col-xs-12 col-md-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<form action ="<?php echo e(route('guardaedicionmTarea')); ?>" method = 'POST' align="center">
					...
					<div class="container col-12">
						<div class="row">
							<div class="form-group col-6">
								...
								Clave Tarea: <input type = 'text' name = 'id_Tarea' value="<?php echo e($infom->id_Tarea); ?>" readonly = 'readonly' class="form-control">
							</div>
							<div class="form-group col-6">
								<?php if($errors->first('NomTarea')): ?>
								<i> <?php echo e($errors->first('NomTarea')); ?> </i> 
								<?php endif; ?>	<br>
								Nombre de Tarea a Realizar: <input type = 'text' name = 'NomTarea' value="<?php echo e($infom->NomTarea); ?>" class="form-control">
							</div>
							<div class="col-md-6 ">
								...
								<div class="well well-sm">
									<div class='input-group date' id='divMiCalendario'>
										Introduzca Fecha de Limite de Realización de Tarea:<input type='text' id="txtFecha" class="form-control"  readonly name = 'FechaLimite' value="<?php echo e($infom->FechaLimite); ?>"/>
						...
						<?php endif; ?>
								<div class="well well-sm">
									<div class='input-group date' id='divMiCalendario2'>
										Introduzca Fecha de Finalización de Tarea:<input type='text' id="txtFecha" class="form-control"  readonly name = 'FechaFin' value="<?php echo e($infom->FechaFin); ?>"/>
										<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
									</span>
								</div>	
							</div>
						...
						<div class="form-group col-6">
							...
							<select name = 'num_folio' class="form-control">
								<option value = '<?php echo e($num_folio); ?>'><?php echo e($abogados->NomAbogado.' '.$abogados->AppAbogado.' '.$abogados->ApmAbogado); ?></option>
								<?php foreach($todosdemas as $ab): ?>
							...
							<select name = 'id_EstTar' class="form-control">
								<option value ="<?php echo e($id_EstTar); ?>"><?php echo e($estado_tareas); ?></option>
								<?php foreach($todasdemas as $et): ?>
