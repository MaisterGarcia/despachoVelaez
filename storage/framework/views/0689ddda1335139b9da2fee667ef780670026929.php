			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-xs-12 col-12" rol="form-crear" id="form-crear-1" style="height: 200px;">
						...
						<form action="<?php echo e(route('impresion')); ?>" method="POST">
												...
												<div class="input-group-prepend">
													<span class="input-group-text" id="basic-addon1">	
														<a href="javascript:void(0);" class="add_button" title="Add field">
															<img src="<?php echo e(asset('archivo/add-icon.png')); ?>" width="30" height="30" />
														</a></span>
													</div>
												...
												<div class="input-group">
														<div class="input-group-prepend">
															<span class="input-group-text">
																	<img src="<?php echo e(asset('archivo/calendar.png')); ?>" width="25" height="25" />
																</span>
														</div>
