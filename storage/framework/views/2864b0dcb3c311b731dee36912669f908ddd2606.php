...
<body>
	...
	<?php /* <script src='<?php echo e(asset('js/jquery-3.1.1.min.js')); ?>' id="JQ" ></script> */ ?>
	<script src="<?php echo e(asset('js/bootstrap.min.js')); ?>" ></script>
	<script src="<?php echo e(asset('js/main.js')); ?>"></script>
	<script src="<?php echo e(asset('js/retraccion_input.js')); ?>"></script>
	<?php /* <script src="<?php echo e(asset('js/bootstrap-datetimepicker.es.js')); ?>" id="JES"></script> */ ?>
