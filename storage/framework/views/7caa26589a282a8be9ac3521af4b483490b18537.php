	...
	<div class="menu-container">
		<div class="menu">
			...
			<div class="menu-container">
				...
				<div class="menu hide">
					<a href="<?php echo e(route('archivoCliente')); ?>" class="option"><i class="icon-attachment"></i>Achivos del cliente</a>
					<?php if(Session::get('sesiontipo')=="admin"): ?>
			...
			<div class="menu-container">
				...
				<div class="menu hide">
					<a href="<?php echo e(route('archivosXCliente')); ?>" class="option"><i class="icon-bookmark"></i> Archivos</a>
				</div>
			</div>	
			<?php endif; ?>
